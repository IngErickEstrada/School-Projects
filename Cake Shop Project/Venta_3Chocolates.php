				...
				<article class="col-xs-12 col-sm-12 col-md-12">
					<div class="table-responsive">
						<table class="table">
							...
							<tr>
								<td>
									<img class="Pasteles_Cliente" src="Imagenes/Menu/3 Chocolates.png">
									<u>3 Chocolates</u>
								</td>
								<td>
									<?php 
										...
										$SQL = $Conexion->query("SELECT Precio FROM menu WHERE id_menu = 1"); 
								...
								<td>
									<input class="btn btn-sm" type="number" name="Cantidad1">
								</td>
								<td>
									<?php
										$P = $Precio;
							...
							<tr>
								...
								<td><input class="btn btn-primary" type="submit" name="btnagregar1" value="Agregar"></td>
