				...
				<article class="col-xs-12 col-sm-12 col-md-12">
					<div class="table-responsive">
						<table class="table">
							...
							<tr>
								<td>
									<img class="Pasteles_Cliente" src="Imagenes/Menu/Yoghurt con fresas.png">
									<u>Yoghurt con Fresas</u>
								</td>
								<td>
									<?php 
										$objConexion = new ConexionDB();
										$Conexion = $objConexion->Conexion_Database();
										$SQL = $Conexion->query("SELECT Precio FROM menu WHERE id_menu = 11"); 
								...
								<td>
									<input class="btn btn-sm" type="number" name="Cantidad11">
								</td>
								<td>
									<?php
										$P = $Precio;
							...
							<tr>
								...
								<td><input class="btn btn-primary" type="submit" name="btnagregar11" value="Agregar"></td>
