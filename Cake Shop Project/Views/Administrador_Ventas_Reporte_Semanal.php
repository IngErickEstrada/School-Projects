					...
					<section class="row">
						<article class="col-xs-12 col-sm-12 col-md-12">
							<div>
								<?php
									$Date = $_POST['Fecha'];
									$Semana = substr($Date,6);

									$objConexion = new ConexionDB();
									$Conexion = $objConexion->Conexion_Database();
									$SQL = $Conexion->query("SELECT WEEK(Fecha_Venta) FROM ventas_realizadas");
									$Result = mysqli_fetch_assoc($SQL);
									$Fecha = $Result['WEEK(Fecha_Venta)'];
									$Fecha = $Fecha + 1;
											...
											<tr>
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL1 = $Conexion->query("SELECT id_Venta FROM ventas_realizadas WHERE '$Semana'='$Fecha'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL2 = $Conexion->query("SELECT id_Pastel FROM ventas_realizadas WHERE '$Semana'='$Fecha'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL3 = $Conexion->query("SELECT id_Factura FROM ventas_realizadas WHERE '$Semana'='$Fecha'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL4 = $Conexion->query("SELECT Cantidad FROM ventas_realizadas WHERE '$Semana'='$Fecha'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL6 = $Conexion->query("SELECT Total FROM ventas_realizadas WHERE '$Semana'='$Fecha'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL7 = $Conexion->query("SELECT Fecha_Venta FROM ventas_realizadas WHERE '$Semana'='$Fecha'");
