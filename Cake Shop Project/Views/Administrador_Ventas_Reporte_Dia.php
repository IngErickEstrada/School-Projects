						...
						<article class="col-xs-12 col-sm-12 col-md-12">
							<div>
								<?php
									...
									$SQL = $Conexion->query("SELECT * FROM ventas_realizadas WHERE Fecha_Venta='$Date'");
											...
											<tr>
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL1 = $Conexion->query("SELECT id_Venta FROM ventas_realizadas WHERE Fecha_Venta='$Date'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL2 = $Conexion->query("SELECT id_Pastel FROM ventas_realizadas WHERE Fecha_Venta='$Date'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL3 = $Conexion->query("SELECT id_Factura FROM ventas_realizadas WHERE Fecha_Venta='$Date'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL4 = $Conexion->query("SELECT Cantidad FROM ventas_realizadas WHERE Fecha_Venta='$Date'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL6 = $Conexion->query("SELECT Total FROM ventas_realizadas WHERE Fecha_Venta='$Date'");
												...
												<th>
													<?php
														$objConexion = new ConexionDB();
														$Conexion = $objConexion->Conexion_Database();
														$SQL7 = $Conexion->query("SELECT Fecha_Venta FROM ventas_realizadas WHERE Fecha_Venta='$Date'");
