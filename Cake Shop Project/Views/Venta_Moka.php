				...
				<article class="col-xs-12 col-sm-12 col-md-12">
					<div class="table-responsive">
						<table class="table">
							...
							<tr>
								<td>
									<img class="Pasteles_Cliente" src="Imagenes/Menu/Moka.png">
									<u>Moka</u>
								</td>
								<td>
									<?php 
										...
										$SQL = $Conexion->query("SELECT Precio FROM menu WHERE id_menu = 8"); 
								...
								<td>
									<input class="btn btn-sm" type="number" name="Cantidad8">
								</td>
								<td>
									<?php
										$P = $Precio;
							...
							<tr>
								...
								<td><input class="btn btn-primary" type="submit" name="btnagregar8" value="Agregar"></td>
