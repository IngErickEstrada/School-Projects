...
<body><meta charset="utf-8">
		...
		<div class="container">
			<section class="row Textos">
				<article class="col-xs-12 col-sm-12 col-md-12">
					...
					<button class="btn btn-primary" type="submit" name="btnalmacen">Enviar</button>						
				</article>							
			</section>
		</div>
	</form>
	...
	<?php 
		if(isset($_POST['btnalmacen']))
		{
			...
			$SQLP1 = "SELECT * FROM almacen WHERE id_Almacen = $Almacen";
			$objConexion = new ConexionDB();
			$Conexion = $objConexion->Conexion_Database();
			...
			<section class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-3">
					<div class="form-group Textos">
						...
						<input class="form-control" type="text" id="Stock" name="Stock" value="<?php echo $stock ?>">

						<a href="Administrador_Almacen.php"><input class="btn btn-block btn-danger" style="margin-top: 10%;" value="Regresar"></a>

						<button class="btn btn-block btn-primary" type="submit" style="margin-top: 3%;" id="btn2" name="btn2">Modificar Almacén</button>
					</div>
				</article>
