				...
				<article class="col-xs-12 col-sm-12 col-md-12">
					<div class="table-responsive">
						<table class="table">
							...
							<tr>
								<td>
									<img class="Pasteles_Cliente" src="Imagenes/Menu/Carlos V.png">
									<u>Carlos V</u>
								</td>
								<td>
									<?php 
										...
										$SQL = $Conexion->query("SELECT Precio FROM menu WHERE id_menu = 5"); 
								...
								<td>
									<input class="btn btn-sm" type="number" name="Cantidad5">
								</td>
								<td>
									<?php
										$P = $Precio;
							...
							<tr>
								...
								<td><input class="btn btn-primary" type="submit" name="btnagregar5" value="Agregar"></td>
