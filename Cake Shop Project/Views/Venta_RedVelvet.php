				...
				<article class="col-xs-12 col-sm-12 col-md-12">
					<div class="table-responsive">
						<table class="table">
							...
							<tr>
								<td>
									<img class="Pasteles_Cliente" src="Imagenes/Menu/Red Velvet.png">
									<u>Red Velvet</u>
								</td>
								<td>
									<?php 
										...
										$SQL = $Conexion->query("SELECT Precio FROM menu WHERE id_menu = 9"); 
								...
								<td>
									<input class="btn btn-sm" type="number" name="Cantidad9">
								</td>
								<td>
									<?php
										$P = $Precio;
							...
							<tr>
								...
								<td><input class="btn btn-primary" type="submit" name="btnagregar9" value="Agregar"></td>
