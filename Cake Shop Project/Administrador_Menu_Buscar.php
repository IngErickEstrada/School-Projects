		...
		<div class="container">
			<section class="row Textos">
				<article class="col-xs-12 col-sm-12 col-md-12">
					...
					<button class="btn btn-primary" type="submit" name="btnmenu">Buscar Pastel</button>						
				</article>							
			</section>
		</div>
	</form>
			...
			<section class="row">
				<article class="col-xs-12 col-sm-12 col-md-3">
					<div class="form-group Textos">
						...
						<input class="form-control" type="text" id="Categoria" name="Categoria" value="<?php echo $auxcategoria; ?>" readonly>
				...
				<article class="col-xs-12 col-sm-12 col-md-3">
					<div class="form-group Textos">
						...
						<input class="form-control" type="text" id="Precio" name="Precio" value="$<?php echo $auxprecio; ?>.00" readonly>
					</div>
				</article>
